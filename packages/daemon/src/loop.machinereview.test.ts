...
import { FleetLoop, machineReviewLine } from "./loop.ts";
import type { MachineReviewOutcome } from "./review.ts";
...
vi.mock("./review.ts", async (importActual) => ({
  ...(await importActual<typeof import("./review.ts")>()),
