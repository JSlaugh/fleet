...
vi.mock("./github.ts", async (importActual) => ({
  ...
  getPrFeedback: vi.fn(async () => ({ hasChangesRequested: true, reviews: [], comments: [], latestAt: "2026-01-02T00:00:00.000Z" })),
...
function makeCtx(shuttingDown: boolean, seed?: TicketRecord): { ctx: LoopContext; state: StateStore } {
